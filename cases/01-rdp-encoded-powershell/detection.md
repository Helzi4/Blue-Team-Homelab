...
## LimaCharlie
- Rule/Signal: PowerShell execution with encoded command line (process = powershell.exe, command_line contains -Enc)
- Validate fields: process path, command_line, user, parent process, timestamp

## Notes
- Likely false positives: Legitimate admin automation can use encoded PowerShell. Context matters:
